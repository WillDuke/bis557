...
We first make the assumption that the predictors in X are indpendent such that $||X||_2^2 = I$.

Let's divide into two cases to deal with the non-differentiability of the absolute value at 0.
...
Because of the absolute value, we know that for $X_j^T Y - n \lambda < 0$ that $\hat{\beta}^{LASSO}$ must be zero.
